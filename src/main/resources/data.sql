...
insert into pizzas (name, size, price, key_ingredients, restaurant_id)
values ('Pizza1', 14, 10.99, 'Dough', 1);
insert into pizzas (name, size, price, key_ingredients, restaurant_id)
values ('Pizza2', 14, 10.99, 'Dough', 1);
insert into pizzas (name, size, price, key_ingredients, restaurant_id)
values ('Pizza3', 15, 12.99, 'Dough', 1);
insert into pizzas (name, size, price, key_ingredients, restaurant_id)
values ('Pizza4', 14, 10.99, 'Dough', 1);
insert into pizzas (name, size, price, key_ingredients, restaurant_id)
values ('Pizza5', 15, 12.99, 'Dough', 1);
